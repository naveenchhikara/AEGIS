...
- The in-repo collateral that *does* make public-facing claims is `README.md`,
...
Restating the claim honestly, the property is: *for the 14 audited tables, and
...
globally monotonic sequence number that no shipped code verifies.* That is not
