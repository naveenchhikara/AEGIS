...
<task type="auto">
  ...
  <action>
    ...
    Component features:
    - Read category, status, and search from useSearchParams()
    ...
    - Search input: filters by requirement title/description with debounce
...
<task type="auto">
  ...
  <action>
    ...
    - Filter data by search term from URL params (searches title and description)
