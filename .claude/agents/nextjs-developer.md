...
<example>
Context: A high-traffic SaaS application needs optimizationÃ¢ÂÂpages are slow, SEO metrics are poor, and the team needs to implement real-time features without rebuilding from scratch.
