...
**Scale:** 551 source files · 1,999-line Prisma schema · 64 DB tables · 360 commits · 104 requirements across 18 modules
...
- **Auth:** Better Auth with scrypt password hashing, session cookies (`__Secure-better-auth.session_token`)
- **RBAC:** 17 roles, 50+ permissions, role-to-permission mapping in `src/lib/permissions.ts`
- **Schema:** 64 tables, Prisma 7 with PostgreSQL adapter (`@prisma/adapter-pg`)
