...
2. AWS SES domain verification status confirmed (SUCCESS, or pending with DNS records added)
3. Test email sent successfully via SES (or SES status documented)
   </success_criteria>
