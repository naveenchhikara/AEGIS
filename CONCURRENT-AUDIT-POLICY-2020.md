...
Changes proposed in the Concurrent Audit Policy, 2018
...
The RBI requirement regarding coverage of not less than 50% of deposits as well as not

less than 50% of credit and other risk exposure of the Bank under Concurrent Audit to be
...
various units set up for that purpose and the scale of transactions / operations undertaken

at these units is large. With a view to ensuring that the functioning of these units is as per

the internal as well as regulatory guidelines and mitigating the risk associated with large-

scale operations such non-branch units also shall be subjected to Concurrent Audit. Data
...
Concurrent Audit are given in Appendix-I.

The broad areas to be covered under Concurrent Audit shall be based on identified risk of
...
ACB by way of reporting of the significant observations.
...
of Assistant General Manager and above would be considered for the same].
...
The following basic criteria should be kept in mind while selecting a firm for Concurrent
...
Audit of branches can be assigned to firms of CAs, depending on the size of the

branch eligibility criteria, as under:-
...
(g) The firm should execute undertaking of fidelity and secrecy on its letterhead in the

format prescribed by the Bank.

(h) The assignment should be carried out in a professional manner and in case of any
...
(k) Any other terms and conditions of the assignment would be decided by the Bank
...
will be purely at the discretion of the Bank and no rights whatsoever accrue to the
...
with the Bank’s Audit Committee of Executives (ACE) and the same be reported
...
are materially significant in relation to the business of the branch for the relevant

business (25% or more of outstanding / volume of business during previous year),
...
once in every three months. This meeting shall be conducted in every region and
...
submission of Concurrent Audit reports, reporting of the significant observations to
...
indicate weakness in the internal control system which presents a significant risk of error but
...
indicate sundry omissions in complying with prescribed policies and procedures of the Bank

which do not have a material impact on the internal control environment
...
Name of C. A. firm :
Address of C.A. Firm :
Details of Branch Audited

The C. A. firm is auditing the
Branch since
...
(Parameters To Be Filled Up By GM – ZAO
...
a. On all working days by
Audit Personnel
b. 1-5 days absence in a month
by Audit Personnel
c. Absence for more than 5
days by Audit Personnel

a. Minimum 10 visits in a
month by Partner
b. 6 visits in a month by
Partner
c. Less than 6 visits by Partner
in a month
Whether any unit inspection of
the CC/OD/TL account is
carried out by the Concurrent
Auditor during the month? If
yes: Full marks
...
a. By 10th day of the
succeeding month

b. Between 11th and 15th day
of the succeeding mth.
...
Detection of Fraud: Firm may be awarded additional 25
marks for detecting any fraud case at branch during the
month.
...
Evaluation of the marks would be done on the baseline marks of 100. The contract
with audit firm falling in Grade 'C' shall be terminated, after giving one month’s
notice period, before completion of the audit term.
