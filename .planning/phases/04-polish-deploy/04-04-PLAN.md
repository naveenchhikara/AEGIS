...
must_haves:
  truths:
    - "All screens render without horizontal scrolling on 375px width (iPhone SE)"
    - "Touch targets are at least 44x44px on mobile"
    - "Dashboard widget grid adapts from 1 column on mobile to 4 columns on desktop"
    - "Data tables have horizontal scroll containers on mobile"
    - "Sidebar collapses to hamburger on mobile"
    - "Padding reduces on mobile (p-4) and expands on desktop (p-6)"
  artifacts:
